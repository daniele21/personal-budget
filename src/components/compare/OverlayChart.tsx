...
export function OverlayChart({ transactions, rangeA, rangeB }: { transactions: Transaction[]; rangeA: DateRange; rangeB: DateRange }) {
  ...
  return (
    <Card className="p-4">
      <p className="text-micro font-bold text-on-surface-variant mb-3">Expense trend overlay</p>
      <div className="h-56">
      ...
      <div className="flex items-center gap-4 text-micro font-bold text-on-surface-variant">
